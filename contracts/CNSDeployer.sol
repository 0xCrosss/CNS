...
import '../node_modules/@ensdomains/ens-contracts/contracts/registry/FIFSRegistrar.sol';
import {NameResolver, ReverseRegistrar} from '../node_modules/@ensdomains/ens-contracts/contracts/registry/ReverseRegistrar.sol';
// import '../node_modules/@ensdomains/ens-contracts/contracts/wrapper/INameWrapper.sol';
import  {INameWrapper, PublicResolver}  from '../node_modules/@ensdomains/ens-contracts/contracts/resolvers/PublicResolver.sol';


// Construct a set of test ENS contracts.
contract ENSDeployer {
  bytes32 public constant TLD_LABEL = keccak256('cross');
